    ...
    <div className="space-y-6">
      ...
      <div>
        <div className="flex items-center justify-between mb-3">
          <h2 className="text-lg font-display">今日训练</h2>
          <span className="text-xs text-neon font-medium bg-neon/10 px-2 py-1 rounded-full">臀腿日</span>
        </div>
        <div className="space-y-2">
          {TODAY_WORKOUT.map((ex, i) => (
            ...
            >
              <div className="w-8 h-8 rounded-lg gradient-neon flex items-center justify-center text-primary-foreground font-bold text-sm font-display">
                {i + 1}
              </div>
              ...
              <span className="text-xs text-muted-foreground">休息 {ex.rest}</span>
            </motion.div>
          ))}
        </div>
      </div>
      ...
      {/* Plans */}
      <div>
        <h2 className="text-lg font-display mb-3">训练方案</h2>
      ...
      {/* VIP Section */}
      <div className="gradient-card rounded-xl p-4 border border-neon/30 relative overflow-hidden">
        ...
        <div className="relative">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h3 className="font-display text-lg">VIP 专属服务</h3>
          </div>
          <div className="space-y-2 mt-3">
            ...
            <div className="flex items-center gap-2 text-sm text-secondary-foreground">
              <Watch className="w-4 h-4 text-neon" />
              <span>手表互联 · 语音训练提醒</span>
            </div>
          </div>
          <button className="mt-4 w-full py-2.5 rounded-xl gradient-neon text-primary-foreground font-bold text-sm font-display tracking-wider">
            开通 VIP
          </button>
        </div>
      </div>
